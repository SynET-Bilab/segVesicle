...
def json_to_excel(json_path, excel_path):
    ...
    for vesicle in data["vesicles"]:
        row = {
            "Name": vesicle["name"],
            "Center X": vesicle["center"][0],
            "Center Y": vesicle["center"][1],
            "Center Z": vesicle["center"][2],
            "Radius X": vesicle["radii"][0],
            "Radius Y": vesicle["radii"][1],
            "Radius Z": vesicle["radii"][2],
            "CCF": vesicle["CCF"],
            "Evec1_X": vesicle["evecs"][0][0],
            "Evec1_Y": vesicle["evecs"][0][1],
            "Evec1_Z": vesicle["evecs"][0][2],
            "Evec2_X": vesicle["evecs"][1][0],
            "Evec2_Y": vesicle["evecs"][1][1],
            "Evec2_Z": vesicle["evecs"][1][2],
            "Evec3_X": vesicle["evecs"][2][0],
            "Evec3_Y": vesicle["evecs"][2][1],
            "Evec3_Z": vesicle["evecs"][2][2]
        }
        rows.append(row)

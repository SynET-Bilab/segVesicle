...
- **Add Missing Vesicles Using 2D Manual Fitting:**  
  If more control is needed, manually annotate the vesicle by left-clicking six points along its membrane in the largest cross-section, then press `P` to perform a 2D manual fit.

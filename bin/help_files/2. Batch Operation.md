...
Navigate to the parent folder of each TOMO_NAME and launch napari:
...
- **Add missing vesicles using 2D manual fitting:** On the largest cross-section of the missing vesicle, left-click six points on the vesicle membrane, then press `P`.

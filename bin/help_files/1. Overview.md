...
Both `Vesicle3D` and `IsoNet` are needed. [IsoNet](https://github.com/IsoNet-cryoET/IsoNet) is used for missing wedge restoration and denoising to improve the segmentation performance. 

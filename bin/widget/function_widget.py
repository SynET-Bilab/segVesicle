...
class ToolbarWidget(QWidget):
    def __init__(self):
        ...
        self.finetune_model_button = self.add_button(self.predict_layout, "Finetune Model")
        ...
        # self.fix_fn_button = self.add_button(self.vesicle_analysis_layout, "Fix False Negative Vesicles")
        ...
        self.export_final_excel_button = self.add_button(self.vesicle_analysis_layout, "Export Working Folder Excel")
